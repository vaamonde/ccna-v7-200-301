...
**DICA-07:** o serviço de TFTP (Trivial File Transfer Protocol) utiliza o Protocolo UDP na Porta Padrão 69 e por padrão está ativo no Servidor.
...
**CUIDADO:** como o Cisco IOS é uma sub-derivação do Unix/BSD, ele também é Case Sensitive (faz diferença de Maiúscula/Minúscula).
...
**OBSERVAÇÃO-08:** recomendo sempre um editor de texto profissional para não modificar a estrutura do arquivo de configuração no momento de copiar e colar, não utilizar, por exemplo: MS Word, Wordpad, etc..., esses editores de Texto modificado a codificação dos arquivos prejudicando no processo de automação dos scripts.

**DICA-10:** copiar as informações do Running Config (RAM) ou Startup Config (NVRAM) a partir da primeira: *! (exclamação)* até a última opção: *end*
...
**OBSERVAÇÃO-10:** em roteadores não temos o comando: *show boot* existente no Switch
...
**OBSERVAÇÃO-11:** o acesso a memória Flash em roteadores é feito utilizando módulos externos, geralmente não são soldados.
